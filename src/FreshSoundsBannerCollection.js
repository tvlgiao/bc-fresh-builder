        ...
        return (
            <form>
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" id="description1" name="description1" rows="4" onChange={this.handleChange} placeholder="Enter the description text">{description1}</textarea>
                </div>
                <div className="form-group">
        ...
        return (
            <form>
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" id="description2" name="description2" rows="4" onChange={this.handleChange} placeholder="Enter the description text">{description2}</textarea>
                </div>
                <div className="form-group">
        ...
        return (
            <form>
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" id="description3" name="description3" rows="4" onChange={this.handleChange} placeholder="Enter the description text">{description3}</textarea>
                </div>
                <div className="form-group">
        ...
        return (
            <form>
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" id="description4" name="description4" rows="4" onChange={this.handleChange} placeholder="Enter the description text">{description4}</textarea>
                </div>
                <div className="form-group">
        ...
        return (
            <form>
                ...
                <div className="form-group">
                    ...
                    <textarea type="text" className="form-control" id="description5" name="description5" rows="5" onChange={this.handleChange} placeholder="Enter the description text">{description5}</textarea>
                </div>
                <div className="form-group">
...
class FreshSoundsBannerCollection extends BaseSectionConfig {
    ...
    constructor(props) {
        ...
        this.state = this.getStateFromLocalStorage() || {
            ...
            actionLink2: "#",
            img3: "/product_images/uploaded_images/so-b3.jpg",
            alt3: "so-b3.jpg",
            title3: "MUSIC",
            subTitle3: "",
            description3: "There are many variations of passages of Lorem Ipsum available, but the majority have suffered",
            actionLink3: "#",
            img4: "/product_images/uploaded_images/so-b4.jpg",
            alt4: "so-b4.jpg",
            title4: "SHOOTING SPORTS",
            subTitle4: "",
            description4: "",
            actionLink4: "#",
            img5: "/product_images/uploaded_images/so-b5.jpg",
            alt5: "so-b5.jpg",
            title5: "CONSTRUCTION",
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="freshSoundsBannerCollection" title={this.title} sectionKey={this.sectionKey}
                ...
                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-sounds-banner-collection" data-template="fresh_sounds_banner_collection" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}
