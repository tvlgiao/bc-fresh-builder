...
class FreshBookSidebarLeftBannerFourFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshBookSidebarLeftBannerFour extends BaseSectionConfig {
    defaultTitle = "Fresh Book Sidebar Left Banner Four";
    scopeName = "FreshBookSidebarLeftBannerFour";

    constructor(props) {
        super(props);

        this.state = this.getStateFromLocalStorage() || {
            avata: 'https://cdn11.bigcommerce.com/s-d7pvcwryxv/product_images/uploaded_images/banner-neil-white.png',
            avataAlt: 'banner-neil-white.png',
            position: '',
            name: 'Discover your next',
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshBookSidebarLeftBannerFour" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshBookSidebarLeftBannerFourFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}

                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-book-sidebar-left-banner-four" data-template="fresh_book_sidebar_left_banner_four" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshBookSidebarLeftBannerFour;
