...
class FreshBookFooterInstagramFormItem extends React.Component {
    constructor(props) {
        super(props);
...
class FreshBookFooterInstagramFormGeneral extends React.Component {
    constructor(props) {
        super(props);
        this.handleChange = this.handleChange.bind(this);
    }
...
class FreshBookFooterInstagram extends BaseSectionConfig {
    defaultTitle = "Fresh Book Footer Instagram";
    scopeName = "FreshBookFooterInstagram";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="freshBookFooterInstagram" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshBookFooterInstagramFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} items_count={this.state.items.length} />,

                    },
                    ...this.state.items.map((item, index) => ({
                        title: `Banner item ${index + 1}`,
                        element: <FreshBookFooterInstagramFormItem onFormItemChange={this.onFormItemChange.bind(this, index)} {...item} />,
                    })),
                ]}


                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-book-footer-instagram" data-template="fresh_book_footer_instagram" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshBookFooterInstagram;
