...
class FreshBannerFeaturedProductsFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshBannerFeaturedProducts extends BaseSectionConfig {
    defaultTitle = "Fresh Banner Featured Products";
    scopeName = "FreshBannerFeaturedProducts";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshBannerFeaturedProducts" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshBannerFeaturedProductsFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}

                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-banner-featured-products" data-template="fresh_banner_featured_products" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshBannerFeaturedProducts;
