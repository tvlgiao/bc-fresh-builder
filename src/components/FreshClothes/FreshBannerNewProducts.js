...
class FreshBannerNewProductsFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshBannerNewProducts extends BaseSectionConfig {
    defaultTitle = "Fresh Banner New Products";
    scopeName = "FreshBannerNewProducts";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshBannerNewProducts" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshBannerNewProductsFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}

                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-banner-new-products" data-template="fresh_banner_new_products" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshBannerNewProducts;
