...
class FreshSoundsFooterInstagramFormItem extends React.Component {
    constructor(props) {
        super(props);
...
class FreshSoundsFooterInstagramFormGeneral extends React.Component {
    constructor(props) {
        super(props);
        this.handleChange = this.handleChange.bind(this);
    }
...
class FreshSoundsFooterInstagram extends BaseSectionConfig {
    defaultTitle = "Fresh Sounds Footer Instagram";
    scopeName = "FreshSoundsFooterInstagram";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="freshSoundsFooterInstagram" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshSoundsFooterInstagramFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} items_count={this.state.items.length} />,

                    },
                    ...this.state.items.map((item, index) => ({
                        title: `Banner item ${index + 1}`,
                        element: <FreshSoundsFooterInstagramFormItem onFormItemChange={this.onFormItemChange.bind(this, index)} {...item} />,
                    })),
                ]}
...
export default FreshSoundsFooterInstagram;
