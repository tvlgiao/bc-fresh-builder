...
class FreshStrollersProductsByCategoryOneFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshStrollersProductsByCategoryOne extends BaseSectionConfig {
    defaultTitle = "Fresh Strollers Products By Category One";
    scopeName = "FreshStrollersProductsByCategoryOne";

    constructor(props) {
        super(props);

        this.state = this.getStateFromLocalStorage() || {
            backgroundImage: 'https://fresh-strollers-demo.mybigcommerce.com/product_images/uploaded_images/banner-stroller-double.jpg',
            backgroundImageAlt: 'banner-stroller-double.jpg',
            backgroundImageCaption: 'https://fresh-strollers-demo.mybigcommerce.com/product_images/uploaded_images/text-banner-stroller-double.png',
            backgroundImageCaptionAlt: 'text-banner-stroller-double.png',
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="freshStrollersProductsByCategoryOne" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshStrollersProductsByCategoryOneFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}


                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-strollers-products-by-category-one" data-template="fresh_strollers_products_by_category_one" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshStrollersProductsByCategoryOne;
