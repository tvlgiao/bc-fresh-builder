...
class FreshStrollersFooterInformationFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshStrollersFooterInformation extends BaseSectionConfig {
    defaultTitle = "Fresh Strollers Footer Information";
    scopeName = "FreshStrollersFooterInformation";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshStrollersFooterInformation" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshStrollersFooterInformationFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}


                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-strollers-footer-information" data-template="fresh_strollers_footer_information" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshStrollersFooterInformation;
