...
class FreshSweetsSidebarRightBannerFourFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshSweetsSidebarRightBannerFour extends BaseSectionConfig {
    defaultTitle = "Fresh Sweets Sidebar Right Banner Four";
    scopeName = "FreshSweetsSidebarRightBannerFour";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshSweetsSidebarRightBannerFour" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshSweetsSidebarRightBannerFourFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}


                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-sweets-sidebar-right-banner-four" data-template="fresh_sweets_sidebar_right_banner_four" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshSweetsSidebarRightBannerFour;
