...
class FreshSweetsSidebarLeftBannerOneFormGeneral extends React.Component {
    constructor(props) {
        super(props);
...
class FreshSweetsSidebarLeftBannerOne extends BaseSectionConfig {
    defaultTitle = "Fresh Sweets Sidebar Left Banner One";
    scopeName = "FreshSweetsSidebarLeftBannerOne";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FreshSweetsSidebarLeftBannerOne" title={this.title} sectionKey={this.sectionKey}
                 panels={[
                    {
                        title: "General",
                        element: <FreshSweetsSidebarLeftBannerOneFormGeneral onFormGeneralChange={this.onFormGeneralChange} {...this.state} heading={this.state.heading} />
                    }
                ]}


                code={`<div class="u-hiddenVisually" data-local-banner-position="fresh-sweets-sidebar-left-banner-one" data-template="fresh_sweets_sidebar_left_banner_one" data-params="${data}">DO NOT REMOVE THIS LINE</div>`}
            />
        );
    }
}

export default FreshSweetsSidebarLeftBannerOne;
